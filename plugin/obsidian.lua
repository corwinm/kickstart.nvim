...
--   pattern = '*.md',
--   callback = function()
-- if vim.fn.getcwd() ~= vault then vim.cmd('cd ' .. vault) end
vim.pack.add { { src = gh 'obsidian-nvim/obsidian.nvim', version = 'v3.16.2' } }
...
registerKeymaps {
  ...
  {
    ',oc',
    function() require('obsidian.api').toggle_checkbox { ' ', 'x' } end,
